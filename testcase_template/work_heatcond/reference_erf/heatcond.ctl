...
200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0, 200.0 # Aerodynamic heating: Altitude (dummy)
0.0071, 0.05098, 0.30318, 1.49661, 6.14571, 21.05686, 60.43443, 146.06092, 299.38454, 525.46733, 800.0, 1074.53267, 1300.61546, 1453.93908, 1539.56557, 1578.94314, 1593.85429, 1598.50339, 1599.69682, 1599.94902, 1599.992 # Aerodynamic heating: Heatflux
...
24                  # (GPS)
# Filename -----------------------------
'../../database/atmospheremodel/atmospheremodel.txt'  # Atmosphere file
'../../database/reference_egg/2017_0715_EGG_ADC_PHY.dat'  # ADC-PHY (flight)
'../../database/reference_egg/2017_0715_EGG_GPS.dat'      # GPS data (flight)
'heatflux.dat'                        # Heat flux result by Monte Carlo (output)
'history.dat'	                      # Time hisotry file name (output)
2                                     # Display verbose: 0:less,  1:more
