...
# Ref: Gpyopt: https://sheffieldml.github.io/GPyOpt/index.html
...
class bayesian_opt(orbital):

  def __init__(self, config, unit_covert_timeunit, time_opt, geodetic_coord_opt):
